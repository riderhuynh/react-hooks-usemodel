...
var DataProvider = (function (_ref) {
  ...
  var put = function put(name, value) {
    setData(_objectSpread2({}, data, _defineProperty({}, name, value)));
  };
...
function createField(model, modelField) {
  ...
  var XField = type && type.prototype && type.prototype instanceof Field ? type : Field;
...
export { useData, subscribe, useModel, Field, Model, withData };
